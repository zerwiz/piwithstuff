...
3. **Directory Integrity:** - All generated documentation MUST be saved to: `/piwithstuff/.pi/docs/`.
   - If the directory does not exist, use your tools to create it.
   - **Verification:** Before finalizing, confirm the output path. If it's outside this directory, correct it immediately.
4. **Output Protocol:**
